...
- **`SPEND_Q` ต้องเติมคำเรื่อย ๆ** เพราะ Gmail ตัดคำไทยเป็น token — `แจ้งรายการ` ไม่แมตช์ `แจ้งการทำรายการ` ทั้งที่เป็นธนาคารเดียวกัน ถ้าเจอบิลที่ไม่ขึ้นในแดชบอร์ด ให้เอาคำจากหัวข้ออีเมลนั้นไปเพิ่มใน `SPEND_Q` (`server/gmail.js`)
